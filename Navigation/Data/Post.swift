...
public struct Post {
    ...
    var post1 = Post(author: "Olivia Johnson",
                     ...
                     likes: 501,
                     views: 721)
    var post2 = Post(author: "Amaliya Harris",
                    ...
                    likes: 343,
                    views: 478)
    var post3 = Post(author: "Robert Collins",
                     description: "In general, teacups come in three types: porcelain, clay and glass. Japanese porcelain teacups are very popular in Japan and can be found in most Japanese homes. They are thin, lightweight and come in a variety of shapes and sizes.",
                     image: "teaCup",
                     likes: 1280,
                     views: 700)
    var post4 = Post(author: "David Grant",
